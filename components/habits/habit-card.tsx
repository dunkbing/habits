...
export function HabitCard({
  ...
  const cardBg = colorScheme === 'dark' ? Colors.habit.cardBackgroundDark : '#fff';
    ...
    <Pressable
      ...
      onLongPress={() => {
        Alert.alert(habit.name, undefined, [
          {
            text: isCompleted ? t('habit.markIncomplete') : t('habit.markComplete'),
      ...
      <View style={styles.topRow}>
        ...
        <View style={styles.info}>
          ...
          <View style={styles.metaRow}>
            ...
            <ThemedText style={[styles.dateLabel, { color: colorScheme === 'dark' ? '#9BA1A6' : '#687076' }]}>
              📅 {todayLabel}
            </ThemedText>
          </View>
        </View>
